...
class SuscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suscription" do
    assert_difference("Suscription.count") do
      post suscriptions_url, params: { suscription: { price: @suscription.price, type: @suscription.type } }
    end
  ...
  test "should update suscription" do
    patch suscription_url(@suscription), params: { suscription: { price: @suscription.price, type: @suscription.type } }
